...
В работе построен приближенный к реальному пайплайн рекомендательной системы для marketplace-данных из датасета [T-ECD](https://huggingface.co/datasets/t-tech/T-ECD). Фокус проекта - не retrieval и не бизнес-правила поверх выдачи, а второй этап многостадийной рекомендательной системы: ранжирование уже отобранных кандидатов.
